...
class SPU(BaseModel):
    ...
    category1 = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, related_name='cart1_spu', verbose_name='一级类别')
    category2 = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, related_name='cart2_spu', verbose_name='二级类别')
    category3 = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, related_name='cart3_spu', verbose_name='三级类别')
...
class SKU(BaseModel):
    ...
    default_image = models.ImageField(max_length=20, default='', null=True, blank=True, verbose_name='默认图片')
...
class GoodsVisitCount(BaseModel):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name = '统计分类商品访问量'
