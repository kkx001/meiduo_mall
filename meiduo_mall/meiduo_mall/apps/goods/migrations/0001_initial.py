# Generated by Django 3.0.6 on 2020-08-21 03:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_image', models.ImageField(blank=True, default='', max_length=20, null=True, upload_to='', verbose_name='默认图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category1', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cart1_spu', to='goods.GoodsCategory', verbose_name='一级类别')),
                ('category2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cart2_spu', to='goods.GoodsCategory', verbose_name='二级类别')),
                ('category3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cart3_spu', to='goods.GoodsCategory', verbose_name='三级类别')),
            ],
            options={
                'verbose_name': '商品SPU',
